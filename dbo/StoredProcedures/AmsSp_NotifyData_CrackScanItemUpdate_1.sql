----------------------------------------------------------------------
-- AmsSp_NotifyData_CrackScanItemUpdate_1
--
...
-- Outputs -
--  @nBlockKey int
--	@dtStartTime datetime - where to start in the EventLog building the AAL.
--
-- Returns -
--	0 - successful.
--	-1 - not found.
...
--
CREATE PROCEDURE AmsSp_NotifyData_CrackScanItemUpdate_1
