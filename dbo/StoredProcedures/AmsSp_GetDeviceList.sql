...
-- AmsSp_GetDeviceList
--
--	Gets a list of devices excluding Profibus devices
-- 
--	
--
--
...
--	-1 - General error.
--
-- Enrico Resurreccion - 02/28/2012
CREATE PROCEDURE AmsSp_GetDeviceList
AS
declare @nReturn int;
set @nReturn = 0;
...
BEGIN TRY
		...
		FROM  
			...
			WHERE (BlockAsgms.EventIdDayOut = '49710') AND (DeviceProtocols.ProtocolId <> 4) AND (DeviceProtocols.ProtocolId <> 5)
		ORDER BY AmsTag 
