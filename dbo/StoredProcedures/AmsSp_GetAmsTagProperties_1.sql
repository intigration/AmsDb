...
-----------------------------------------------------------------------
-- AmsSp_GetAmsTagProperties_1
--
-- Get AmsTag properties.
...
--
-- Joe Fisher, 05/04/2001
--
-- Source control keywords --
-- $Date: 2/17/05 3:47p $
-- $Revision: 121 $
--
CREATE PROCEDURE AmsSp_GetAmsTagProperties_1
...
begin
	...
	declare @sColumnName as nvarchar(256), @sColumnValue as nvarchar(256)
