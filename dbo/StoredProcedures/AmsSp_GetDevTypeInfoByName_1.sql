...
-----------------------------------------------------------------------
-- AmsSp_GetDevTypeInfoByName_1
--
-- Get device type info by name.
--
-- Inputs -
--	@sManufacturerName	nvarchar(256)
--	@sProtocolName 		nvarchar(256)
--	@sDeviceTypeName	nvarchar(256)
--	@sDeviceRevisionName	nvarchar(256)
--
-- Outputs -
--	ManufacturerName
--	ProtocolName
...
--
CREATE  PROCEDURE AmsSp_GetDevTypeInfoByName_1
@sManufacturerName	nvarchar(256),
@sProtocolName 		nvarchar(256),
@sDeviceTypeName	nvarchar(256),
@sDeviceRevisionName	nvarchar(256),
...
errorHandler:
PRINT 'AmsSp_GetDevTypeInfoByName_1: ' + @sErrorMsg
RETURN -2
