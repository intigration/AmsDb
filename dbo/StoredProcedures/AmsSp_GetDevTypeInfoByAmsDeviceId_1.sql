...
-----------------------------------------------------------------------
-- AmsSp_GetDevTypeInfoByAmsDeviceId_1
--
-- Get device type info by AmsDeviceId (ie GUID).
--
-- Inputs -
--	@sAmsDeviceId	nvarchar(256)
--
-- Outputs -
--	ManufacturerName
--	ProtocolName
...
--
CREATE  PROCEDURE AmsSp_GetDevTypeInfoByAmsDeviceId_1
@sAmsDeviceId	nvarchar(256),
...
WHERE     (dbo.Devices.AmsDeviceId = @sAmsDeviceId)
...
errorHandler:
PRINT 'AmsSp_GetDevTypeInfoByAmsDeviceId_1: ' + @sErrorMsg
RETURN -2
