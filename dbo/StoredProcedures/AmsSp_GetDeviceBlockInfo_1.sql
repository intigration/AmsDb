...
-----------------------------------------------------------------------
-- AmsSp_GetDeviceBlockInfo_1
--
-- Get device Block Info in XML.
--
-- Inputs -
...
--
-- Outputs -
--	@sReturedBlockInfo nvarchar(4000)
--
-- Returns -
...
-- $Revision: 121 $
--
CREATE PROCEDURE AmsSp_GetDeviceBlockInfo_1
@sMfrName as nvarchar(255),
@sProtocolName as nvarchar(255),
@sDeviceTypeName as nvarchar(255),
@sDeviceRevisionName as nvarchar(255),
@sSerialNumber as nvarchar(255),
@sReturedBlockInfo nvarchar(4000) OUTPUT
AS
...
create table #AmsSp_GetDeviceBlockInfo_1_tbl
(
	...
	BlockIndex	int,
	AmsTag		nvarchar(40),
	BlockInfoAsXml	nvarchar(4000)
)

declare aCursor cursor for select distinct
		...
		dbo.AmsVw_CurrentTagBlockAsgms.AmsTag,
		dbo.AmsUdf_GetFFBlockName(dbo.Blocks.BlockType,	dbo.Blocks.BlockIndex) as BlockName
FROM         dbo.AmsVw_CurrentTagBlockAsgms RIGHT OUTER JOIN
		...
		dbo.Blocks ON dbo.Devices.DeviceKey = dbo.Blocks.DeviceKey ON 
		dbo.AmsVw_CurrentTagBlockAsgms.BlockKey = dbo.Blocks.BlockKey
		
WHERE     (dbo.Devices.DeviceKey <> -1 and dbo.Manufacturers.Name=@sMfrName and
			 dbo.DeviceTypes.Name=@sDeviceTypeName and
			  dbo.DeviceRevisions.Name=@sDeviceRevisionName and
			   dbo.Devices.Identifier=@sSerialNumber and
			    dbo.DeviceProtocols.Name=@sProtocolName)
...
declare @BlockInfoAsXml	nvarchar(4000)
...
--print 'inserting into #AmsSp_GetDeviceBlockInfo_1_tbl blockKey- ' + convert(nvarchar(20), @FinalBlockKey)

			insert into #AmsSp_GetDeviceBlockInfo_1_tbl (Manufacturer,
					MfrId,
					ProtocolId,
					Protocol,
					DeviceTypeCode,
...
set @sReturedBlockInfo = ''
set @sReturedBlockInfo = (select top 1 BlockInfoAsXml from #AmsSp_GetDeviceBlockInfo_1_tbl)

drop table #AmsSp_GetDeviceBlockInfo_1_tbl
